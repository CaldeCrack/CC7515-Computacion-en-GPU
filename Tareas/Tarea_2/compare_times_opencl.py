...
csv_path = "opencl_benchmark.csv"
df = pd.read_csv(csv_path)

df["Cells/s (Millions)"] = df["Cells/s"] / 1_000_000_000
df["Length"] = df["Length"].apply(np.log2)
thread_config = {"OpenCL": 128, "OpenCL Ifs": 128, "OpenCL 2D": 128}
...
plt.title("Comparación de ejecuciones para los distintos modos de OpenCL")
...
plt.tight_layout()
plt.show()
plt.savefig("img/opencl_time_comparison.png")
